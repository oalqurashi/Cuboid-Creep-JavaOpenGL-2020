    ...
    public Map(int mapNum) {
        ...
        switch(mapNum){
            ...
            case 1:
                ...
                Worm2.safeRoom = paths.get(paths.size()-1);
            ...
            case 3:
                ...
                paths.add(new Path("drawHPathNT", walls, boxes[8][1], boxes[10][1]));
                paths.add(new Path("drawVPathLL", walls, boxes[10][1], boxes[10][3]));
                paths.add(new Path("drawHPathTTD", walls, boxes[10][3], boxes[11][5], boxes[9][5]));
                paths.add(new Path("drawVPathTL", walls, boxes[3][5], boxes[3][9]));
                paths.add(new Path("drawVPathRRR", walls, boxes[1][5], boxes[1][1], boxes[1][8]));
                paths.add(new Path("drawHPathNDD", walls, boxes[1][3], boxes[9][8], boxes[5][8]));
                paths.add(new Path("drawVPathCN", walls, boxes[5][4], boxes[5][7]));
                ...
                spiders.add(new Spider(-8,1));
                spiders.add(new Spider(-7,2));
                spiders.add(new Spider(-6,3));
                spiders.add(new Spider(-5,4));
                
                spiders.add(new Spider(8,4));
                spiders.add(new Spider(7,3));
                spiders.add(new Spider(6,2));
                spiders.add(new Spider(5,1));
            ...
            case 4:
               ...
               // paths.add(new Path("drawVPath", walls, boxes[4][9], boxes[4][11]));
                ...
                kingSpider = new KingSpider(-9, 0);
                spiders.add(new Spider(-8,0));
                spiders.add(new Spider(-7,0));
                spiders.add(new Spider(-6,0));
                spiders.add(new Spider(-5,0));
